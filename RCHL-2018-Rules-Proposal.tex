...
%{\Large Changes in the content of the rules from 2017 to 2018 are either \added{marked in magenta text color} (for additions) or by  \removed{crossed out text} (for deletions).}
