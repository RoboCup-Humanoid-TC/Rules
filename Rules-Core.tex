...
\begin{document}
    ...
    \begin{center}
        ...
        Laws of the Game
        \\ \vspace{0.5cm}
        \added{2025}\removed{2023/2024}}

        \bigskip

        {\bfseries \added{April 8th, 2025}\removed{March 17th, 2024}}
    \end{center}
...
\input{Section_III/parkour}
\input{Section_III/high-kick}
\input{Section_III/obstacle_navigation}
\input{Section_III/long-stride}
\input{Section_III/software-challenge}
\input{Section_III/collaborative-challenge.tex}
