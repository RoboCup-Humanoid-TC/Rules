...
Each team must name at least one person who is familiar with the rules and who might be assigned for referee duties \added{and for the technical inspection} by the league organizing committee.
...
\item Soccer games for AdultSize \removed{(1 vs. 1)} \added{(2 vs. 2)},
...
\removed{In the event of less than 3 teams participating in TeenSize the TeenSize teams will join the AdultSize competition.}
...
\item The ball is in play when it is \removed{touched} \added{kicked and clearly moves as determined by the referee} or 10 seconds elapsed after the signal.
\end{itemize}
...
\begin{enumerate}
\item The referee blows the whistle, announces \removed{'Free-Kick' Blue or Red.} \added{the offence and the free kick (e.g 'Pushing Red - Direct Free-Kick Blue')}
\item The assistant referee who operates the game controller clicks on "Direct / Indirect Free Kick" Blue/Red.
\item The referee places the ball depending on the call and announces "Free Kick Ready". \added{Until the referee announced the free kick to be ready robots may move their head to track the ball but must otherwise remain stationary. Robots which are significantly moving during this phase are removed from the field.}
\item The assistant referee who operates the game controller clicks on "\removed{Freeze} Prepare Direct / Indirect Free Kick" Blue/Red. \added{The player taking the free kick has up to 30 seconds to position themselves for the free kick. The team taking the free kick may announce that the player is ready to take the free kick at any point. Opponent robots must move to a position at least 0.5 m away from the ball. They are guaranteed at least 15 seconds to move away from the ball. They may take up to 30 seconds if the team taking the free kick has not announced their robot is ready to take the kick off} \removed{have a maximum of 15 secs to do this. During the 15 seconds, robots of the team that got awarded the free kick may re-position themselves as well}.
\item The assistant referee announces that \removed{the} 15 seconds \added{and, if applicable, 30 seconds} are over.
\item \added{The referee may decide to execute the free kick any time between 15 and 30 seconds have passed depending on the call of the team taking the free kick and the position of the opponent robots. The referee may also allow the free kick to be executed before 15 seconds have passed if the team taking the free kick have announced their robot is ready and if no opponent is within the 0.5 m radius.}
\item Any opponent robot still closer than 0.5 m is considered as an incapable player and must be removed from the field for 30 seconds removal penalty.
\item \removed{After 15 seconds or sooner if the referee considers the kicking team to be ready}\added{When the referee decides to execute the free kick} and all opponent robots are at least 0.5 m away or have been removed from the field, the referee blows the whistle. Then the assistant referee who operates the game controller clicks on "Execute Direct / Indirect Free Kick" Blue/Red. The team that was awarded the free-kick can kick now.
\item The ball is in play after it has been \removed{touched} \added{kicked and clearly moves as determined by the referee} \removed{by a player} or after 10 secs.
\end{enumerate}
...
The referee blows the whistle, announces 'Free-Kick' blue or red and then places the ball depending on the call. The assistant referee who operates the game controller clicks on ``\removed{Prepare} Direct / Indirect Free Kick'' Blue/Red. The referee places the ball depending on the call and announces "Free Kick Ready" and the assistant referee clicks on ``\removed{Freeze} Prepare Direct / Indirect Free Kick'' Blue/Red. \added{The player taking the free kick has up to 30 seconds to position themselves for the free kick. The team taking the free kick may announce that the player is ready to take the free kick at any point.}

\added{Players are guaranteed at least 15 seconds to move away from the ball. They may take up to 30 seconds if the team taking the free kick has not announced their robot is ready to take the kick off. Any opponent robot still closer than 0.5 m is considered as an incapable player and must be removed from the field for 30 seconds removal penalty.  The referee may decide to execute the free kick before 15 seconds have passed if the team taking the free kick have announced their robot is ready and if no opponent is within the 0.5 m radius}. Once the free kick can be executed, the referee blows the whistle and the assistant referee clicks on ``Execute Direct / Indirect Free Kick'' Blue/Red. 
...
Servicing robots on the playing field is not permitted. A robot may be taken out of the field for service, after receiving permission from the referee. Taking out a robot for service does not count as a substitution. A serviced robot may not come into play again before \removed{60} \added{30} seconds elapsed after it was taken out \removed{(if the robot is suffering a 30 second removal penalty already, 30 additional seconds will be added so that the total time of absence is at least 60 seconds)}. It has to enter the field from the team's own half of the field close to the penalty mark facing the opposite touch line, as indicated by the referee. \added{The same rules as for \textit{Removal Penalty} apply.}
...
\item \removed{A robot suffering a penalty (except called for inactivity or service) may not be serviced. A robot suffering a penalty due to a foul or misconduct has to stay out of play for a minimum of 60 seconds if it is serviced during the penalty time.}
...
\item \added{After the robot has been placed at the position indicated by the referee and with both feet entirely outside the field of play the robot handler announces to the assistant referee that the robot is ready to get back in. The 30 seconds penalty start counting from the point of announcement. From this point onwards the robot handler may not touch or interfere with the robot in any other way (including button presses). If any part of the robot touches the field of play (including touch lines) or the robot handler touching the robot before the 30 seconds expired, the time is reset.}
\item \added{The assistant referee operating the GameController will:}
\begin{itemize}
\item \added{Penalize the robot as soon as the referee calls the penalty.}
\item \added{Marks the penalty time counting down as soon as the robot handler announced the robot being ready to walk in}
\item \added{Resets the penalty time whenever the robot handler touches the robot or the robot touches the field of play}
\end{itemize}
\added{The penalty is automatically removed after 30 seconds of penalty have expired.}
\end{itemize}
...
A team may \removed{extend a stoppage of the game by taking} \added{call for} a timeout \added{before kick-off after a goal was scored, the start of a new half, or a drop ball was called and before a penalty shoot-out}. During a timeout robots may be serviced. Each team may take at most one timeout per period \added{during regular game time and one additional timeout during all of the extended time and penalty shoot-out}. If a team is not ready to resume the game when the referee wants to start the game, it has to take a timeout. If there is no timeout left, the referee will start the game anyway. A timeout ends automatically after 120 s. A timeout also ends when the team signals its end to the referee.

\bigskip

{\bfseries Referee Timeouts}

The head referee may call a timeout \removed{at any stoppage of play} \added{before kick-off after a goal was scored, the start of a new half, or a drop ball was called and before a penalty shoot-out} if they deem it necessary. A referee timeout should only be called in dire circumstances - one example might be when the power to the wireless router is down. However, when and whether to call a referee timeout is left up to the head referee.
...
\item The games are played with 5 players in a KidSize team,
      4 players in a TeenSize team and \added{3 }\removed{2} players in an AdultSize team.
      \added{If there is an insufficient number of participants,
             games may be played 4 vs. 4 or 3 vs. 3 for KidSize,
             3 vs. 3 or 2 vs. 2 for TeenSize,
             or 2 vs 2 for AdultSize.}
      \removed{If there is an insufficient number of participants,
      games may be played 4 vs. 4 resp. 3 vs. 3 or 3 vs. 3 resp. 2 vs. 2 for KidSize resp. TeenSize.}
\item Games may end in a draw.
\item Each of the players has a jersey number from the set {1, 2, 3, 4, 5}, resp. {1, 2, 3, 4} resp. {1, 2\added{, 3}}.
...
Referees will be drawn from the remaining participating teams, or if needed, due to a low number of teams, the TC and OC will provide referees. \added{Referees for a match may be picked among the pool of available referees from any size class.}
...
The Best Humanoid Award is awarded to the team ranked first in the Best Humanoid list\added{,
