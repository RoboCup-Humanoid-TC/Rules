...
\added{
  ...
  \item Teams which cannot provide a full roster have to form a
    ...
    a full roster.
  \item Teams which can provide a full roster are allowed are allowed to play as
    full team on their own,
    but can also join other teams to form a combined team.
  \end{itemize}
  
  In case one or more teams are left and the total number of their robot is
  not sufficient to form a full roster,
  they are still allowed to play as a full team.
  
  This ensures that:
  \begin{itemize}
  \item any team who register can compete in regular tournament,
    independently of the number of robots they bring.
  \item any team who bring a full roster is not required to merge with another
...
\added{The competition starts by the Drop-In tournaments.
  ...
  establish a preliminary ranking used for seeding teams in the different groups
  of the round robins.
  ...
  only the best score of the teams composing the full team is used~\footnote{%
    \added{%
      ...
      form a full team,
      the score of the full team will be $4.5$.
    }
  }.
  ...
  \item The best $N$ full teams are qualified for the first round robin of division A
    \footnote{$N$ is either 8 or 12 depending on the number of full team,
      it has to be announced before the beginning of the Drop-In.}.
  ...
  then the team which are ranked lowest from division A will have a playoff
  with the highest ranked teams in division B.
  The winners of the playoff are qualified for the second round robin of
  division A and the loosers are qualified for the second round robin of
  division B.

  From then on, they proceed independently with their second round robin and
  a number of knock-out games.
