...
\added{Teams are required to submit their robot model by creating a pull request to the HLVS repository~\footnote{\url{https://github.com/RoboCup-Humanoid-TC/hlvs_webots}}. If a team is not capable of sharing their model in this way, they need to contact the TC to make a special arrangement.}
\removed{Teams who do not want their robot model to be shared publicly should
