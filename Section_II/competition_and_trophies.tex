...
\item The assistant referee who operates the game controller clicks on
      "\removed{Freeze} Prepare Direct / Indirect Free Kick" Blue/Red.
      \added{The player taking the free kick has up to 30 seconds to position
      ...
      TeenSize and 1.5m for AdultSize away from the ball.
      ...
      \removed{have a maximum of 15 secs to do this. During the 15 seconds,
      robots of the team that got awarded the free kick may re-position themselves as well}.
\item The assistant referee announces that \removed{the} 15 seconds \added{and, if applicable, 30 seconds} are over.
\item \added{The referee may decide to execute the free kick any time between 15 and 30 seconds
...
\item Any opponent robot still \removed{closer than 0.5 m} \added{illegally positioned} is considered as an incapable player and must be removed from the field for 30 seconds removal penalty.
\item \removed{After 15 seconds or sooner if the referee considers the kicking team to be ready}
      \added{When the referee decides to execute the free kick} and all opponent robots are
      \removed{at least 0.5 m away} \added{legally positioned} or have been removed from the field,
...
\item The ball is in play after it has been \removed{touched by a player}
      \added{kicked and clearly moves as determined by the referee} or after 10 secs.
\end{enumerate}
...
\added{Players are guaranteed at least 15 seconds to move away from the ball.
