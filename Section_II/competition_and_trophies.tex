...
\begin{itemize}
\item \removed{should position themself behind the robot at a distance of at least an arm length away from the robot's convex hull.}
...
\added{If during a throw-in procedure, the thrower uses their hands for entering the ball and as a result the thrower's team scores a goal, the thrower is awarded 1 additional point. This additional point is only awarded if the goal is scored before the next game interruption.}
