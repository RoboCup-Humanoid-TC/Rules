...
\bigskip
\added{
      {\bfseries Announcement of co de and hardware usage}
      
      \headlinebox
      
      Teams are required to clearly state in their TDP:
      ...
      \item \added{in case they decide to use software or hardware by another team after the qualification material has already been approved a team needs to write an e-mail to the Humanoid League mailing list.}
      \end{itemize}
