...
\added{In AdultSize, teams may decide to let their robot fall instead of picking it up. If the robot falls, but does not manage to get up by itself and thus needs to be removed, it only suffers a 15 second time penalty instead of 45 seconds. If the robot manages to stand up by itself, it will not suffer a penalty.}
...
seconds removal penalty \added{in KidSize, and a 45 second removal penalty in AdultSize}.
