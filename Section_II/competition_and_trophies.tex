...
\begin{itemize}
\item Combined teams ranked 1-6 are qualified for division A
\item Combined teams ranked 7-10 play one playoff for division A
...
A minimum of \removed{3} \added{X} drop-in games will be played by every team.
