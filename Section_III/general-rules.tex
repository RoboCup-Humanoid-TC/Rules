...
Only the robots \removed{used for the soccer games} \added{that passed the robot inspection} are allowed to participate in the technical challenges.
...
For each part, the highest ranked \added{fully successful} team receives 10 points.
The second \added{fully successful} team receives 7 points.
The third \added{fully successful} team receives 5 points.
All other teams \added{who were fully successful in} \removed{who successfully managed} this part of the challenge receive 3 points.
\added{In case a team with only partial success has been ranked first, second or third in a challenge, they receive 5, 3 or 2 points respectively. 
