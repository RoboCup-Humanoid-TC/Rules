...
Bottles of mass \removed{1$\,$kg, 2$\,$kg,} 3$\,$kg, 5$\,$kg
\added{and 10$\,$kg} will be available,
where the default mass to use \removed{in each size class} will be
\removed{1$\,$kg in KidSize, 2$\,$kg in TeenSize and} 3$\,$kg in AdultSize.
