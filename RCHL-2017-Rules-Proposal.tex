...
{\Large The format of the rules changed from 2016 to 2017. Intended changes in the content of the rules from 2016 to 2017 are either \textcolor{magenta}{marked in magenta text color} (for additions) or by  \textcolor{blue}{\sout{crossed out text}} (for deletions).}
