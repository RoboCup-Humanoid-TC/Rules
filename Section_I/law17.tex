...
\phantomsection
\addcontentsline{toc}{subsection}{Law 17 -- The Corner Kick}


\bigskip

A corner kick is a method of \removed{continuing} \added{restarting} play.
...
\added{A goal may be scored directly from a corner kick, but only against the opposing team; if the ball directly enters the kicker's goal a corner kick is awarded to the opponents.}
...
If the ball leaves the field it will be replaced on the field by the referee or an assistant referee. \removed{There is no stoppage in play.} \added{If the whole of the ball passes over the goal line the ball is placed on the corner on the side of the field the ball went out.}
...
distance of about 40 cm orthogonal to the position on the touch line and
...
\item \removed{If the ball was last touched by the defensive team then the ball
