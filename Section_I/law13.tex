...
The referee blows the whistle, announces 'Free-Kick' \removed{cyan or Magenta} blue or red and then places the ball depending on the call. The assistant referee who operates the game controller clicks on \added{``Prepare Direct / Indirect Free Kick'' Blue/Red} \removed{Free Kick Cyan/Magenta Ready}. \added{The referee places the ball depending on the call and announces "Free Kick Ready" and the assistant referee clicks on "Freeze Direct / Indirect Free Kick'' Blue/Red. Once the free kick can be executed, the referee blows the whistle and the assistant referee clicks on "Execute Direct / Indirect Free Kick'' Blue/Red.}
...
\item the ball is in play when it is kicked and moves (new): \added{for at least 20cm} or 10 seconds after the referee gave the signal
...
\greyed{\added{(suspended:)}
\textbf{Free kick taken by a player other than the goalkeeper}

If, after the ball is in play, the kicker touches the ball again (except with his hands) before it has touched another player \removed{(new) or before it was moved for at least 20 cm}:
...
\added{(suspended:)} If, after the ball is in play, the kicker deliberately handles the ball before it has touched another player \removed{(new) or before it was moved for at least 20 cm}:
...
\added{(suspended:)} \textbf{Free kick taken by the goalkeeper}

If, after the ball is in play, the goalkeeper touches the ball again (except with his hands), before it has touched another player \removed{(new) or before it was moved for at least 20 cm}:
...
\added{(suspended:)} If, after the ball is in play, the goalkeeper deliberately handles the ball before it has touched another player \removed{(new) or before it was moved for at least 20 cm}:
