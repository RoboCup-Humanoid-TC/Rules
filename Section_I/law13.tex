...
\begin{itemize}
\item at least \removed{0.5 m} \added{0.75m for KidSize and TeenSize and 1.5m for AdultSize} \greyed{(replaces: 9.15 m (10 yds))} from the ball until it is in play, unless they are on their own goal line between the goalposts 
