...
\greyed{
  ...
  (suspended: The position of the goalposts in relation to the goal line must be
...
Nets\simplify{ (new:)} which must not be green or white may be attached to the
...
The lighting resembles that of either artificial or natural light.
