...
A penalty mark is made \removed{2.1} \added{1.5} m from the midpoint between the goalposts and equidistant to them. 
...
\hline
G & Penalty mark distance & \multicolumn{2}{c|}{\removed{2.1} \added{1.5} m}\\
\hline
