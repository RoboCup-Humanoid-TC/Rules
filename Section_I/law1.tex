...
Nets \textcolor{magenta}{(new:) which must not be green or white} may be attached to the goals and the ground behind the goal, provided that they are properly supported and do not interfere with the goalkeeper. 
