...
\removed{Fouls and misconduct are penalised as follows:}
\added{Direct and indirect free kicks and penalty kicks can only be awarded for offences and infringements committed when the ball is in play}
...
A penalty kick (new) as defined by Law 14 is awarded if any of the above \added{six} \removed{eleven} \greyed{(replaces: ten}) offences is committed by a player inside his own penalty area, irrespective of the position of the ball, provided it is in play.
