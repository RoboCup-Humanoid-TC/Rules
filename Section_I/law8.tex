...
A goal may (new:) not be scored directly from the kick-off \added{by the team taking the kick-off}.
Either the ball must move \removed{20 cm from the kick-off point}
\added{entirely outside the centre circle} or must be touched by another player
before being kicked into the goal.
If the ball is kicked directly into the goal \removed{the kick-off} \added{a goal-kick}
