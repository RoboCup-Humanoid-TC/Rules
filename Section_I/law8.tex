...
\item the opponents of the team taking the kick-off are at least 1.5 m from the ball until it is in play \textcolor[rgb]{0.4,0.4,0.4}{(replaced:
...
The referee drops the ball at the place where it was located when play was stopped, unless play was stopped inside the goal area, in which case the referee drops the ball on the goal area line parallel to the goal line at the point nearest to where the ball was located when play
was stopped.
