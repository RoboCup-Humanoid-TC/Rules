...
\item the opponents of the team taking the kick-off are at least 0.75 m from the ball until it is in play \greyed{(replaces:
...
\item the ball is in play when it is touched \greyed{(replaces: kicked and moves forward)} (new: or 10 seconds after the referee gave the signal)
\greyed{\item 
