...
A goal kick is a method of \removed{continuing} \added{restarting} play.
...
A goal may be scored directly from a goal kick, but only against the opposing team. \added{If the ball directly enters the kicker's goal a corner kick is awarded to the opponents if the ball left the penalty area.}
...
If the ball leaves the field it will be replaced on the field by the referee or an assistant referee. \removed{There is no stoppage in play.} \added{If the whole of the ball passes over the goal line the ball is placed on the touch line at the intersection with the centre line on the side of the field the ball went
out.}

\bigskip

\removed{The positions for replacement of the ball are described in the
following with respect to the touch lines and always meant to be in a distance of about 40cm orthogonal to the position on the touch line and inwards to the playing field.}

\removed{If the whole of the ball passes over a goal line then the ball will be
...
\item \removed{If the ball was last touched by the offensive team then the ball
...
\added{After placing the ball, the same procedure and rules of executing a direct free kick apply.}
