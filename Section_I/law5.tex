...
\item stops the match if, in their opinion, a player is seriously injured and ensures that he is removed from the field of play. An injured player may only return to the field of play  before the respective penalty time is over \greyed{ (replaces: after the match has restarted)}
