...
Law 5 -- The Referee}
\addcontentsline{toc}{section}{LAW 5 -- The Referee}
...
\item stops the match if, in their opinion, a player is seriously injured and ensures that he is removed from the field of play. An injured player may only return to the field of play  before the respective penalty time is over {\color[rgb]{0.4,0.4,0.4} (replaces: after the match has restarted)}
