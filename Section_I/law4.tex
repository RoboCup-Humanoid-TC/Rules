...
\added{\item The armspan, i.e. the distance from the tip of one hand to the tip of the other, with arms outstretched in a 90 degree angle to the torso, cannot exceed $H_{top}$.}
\end{itemize}
