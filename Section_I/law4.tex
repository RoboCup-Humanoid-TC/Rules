...
\item (new) The robots must be marked with team markers.
 ...
 $0.06\cdot {H_{top}}^2$. The visible area of the one to five largest team markers on each side must be at least $0.015\cdot {H_{top}}^2$}. If both teams cannot agree, which team colour to use, a coin will be flipped an hour prior to the game to assign the team colours.
