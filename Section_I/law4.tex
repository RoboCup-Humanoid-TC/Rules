...
\added{To ensure that no devices are accidentally connected to the wireless network, the password of the network is changed after every game. The passwords will be provided by the Technical Committee before the tournament.}
