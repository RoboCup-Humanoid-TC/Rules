...
\begin{itemize}
\item 40 cm ${\leq}$ $H_{top}$ ${\leq}$ \removed{90} \added{XXX} cm to play in the KidSize class,
\item \removed{80 cm ${\leq}$ $H_{top}$ ${\leq}$ 140 cm to play in the TeenSize class,}
\item \removed{130} \added{XXX} cm ${\leq}$ $H_{top}$ ${\leq}$
      \removed{180} \added{XXX} cm to play in the AdultSize class.
\end{itemize}
...
\headlinebox
\begin{itemize}
\item The maximum weight for robots allowed to play in the \removed{TeenSize}
      \added{KidSize} class is \removed{20} \added{XXX} kg.
