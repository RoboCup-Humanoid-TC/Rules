...
\phantomsection
\addcontentsline{toc}{subsection}{Law 14 -- The Penalty Kick (suspended)}
...
\begin{itemize}
\item (new:) is placed at the position where the offence occurred \added{if a penalty kick is taken during the normal course of play}
\item \added{must be placed on the penalty mark (new:) during penalty shoot-out}
\end{itemize}
...
\item at least 9.15 m (10 yds) from the penalty mark)
\end{itemize}
}
