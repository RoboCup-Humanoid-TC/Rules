...
\phantomsection
\addcontentsline{toc}{section}{Law 14 -- The Penalty Kick (suspended)}
...
\begin{itemize}
\item \added{is placed on the goal area line parallel to the goal line, closest to where the offence occured} \removed{is placed at the position where the offence occurred} \greyed{(replaces: must be placed on the penalty mark)}
\end{itemize}

\bigskip

\greyed{(suspended: The player taking the penalty kick:}

\begin{itemize}
\item \greyed{must be properly identified)}
\end{itemize}
...
The same procedure as in regular direct free kicks is applied.
\\
